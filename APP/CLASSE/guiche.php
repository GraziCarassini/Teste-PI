...
// Essa classe é útil porque centraliza a lógica relacionada ao guichê, mantendo o código limpo e organizado. Ela também facilita a reutilização das operações em outras partes do seu sistema. Além disso, ao utilizar a classe Database para interagir com o banco de dados, você garante uma camada de segurança e padronização nas consultas SQL.
